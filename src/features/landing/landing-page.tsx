    ...
    <main className="landing-canvas public-canvas min-h-screen overflow-hidden text-[var(--soft-ink)]">
      ...
      <section className="relative mx-auto grid min-h-[760px] max-w-[1500px] items-center gap-14 px-5 py-20 sm:px-9 lg:grid-cols-[.9fr_1.1fr] lg:px-14 lg:py-28" id="landing-content">
        ...
        <div className="relative">
          <p className="inline-flex items-center gap-2 rounded-full bg-[#efddd4] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.18em] text-[#7f4939]"><Sparkles size={13} />Progress without pressure</p>
          ...
          <div className="mt-10 flex items-center gap-5 text-xs text-[#56615b]"><div className="flex -space-x-2">{["#2f6f5e", "#a35f49", "#456c85"].map((color) => <span className="size-8 rounded-full border-2 border-[#eceee8]" key={color} style={{ backgroundColor: color }} />)}</div><span>No streak anxiety.<br />Just honest progress.</span></div>
        </div>
      ...
      <section className="mx-auto max-w-[1500px] px-5 pb-24 sm:px-9 lg:px-14 lg:pb-32" id="month">
        <div className="relative overflow-hidden rounded-[40px] bg-[#e7d9cd] px-7 py-14 sm:px-12 lg:grid lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:px-20 lg:py-20">
          ...
          <div className="relative"><p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#7f4939]">A report worth keeping</p><h2 className="mt-5 text-5xl font-semibold leading-[.96] tracking-[-0.06em]">Your month becomes a story you can see—and share.</h2><p className="mt-6 max-w-xl text-base leading-7 text-[#594d46]">Celebrate consistency and completed quests with a polished monthly recap. Private notes and missed-day details stay private.</p></div>
          <div className="relative mt-12 lg:mt-0 lg:pl-16"><div className="relative aspect-square max-w-[430px] overflow-hidden rounded-[34px] bg-[#173f32] p-7 text-white shadow-[0_28px_65px_rgba(23,63,50,.24)]"><div className="absolute -right-16 -top-16 size-52 rounded-full border-[36px] border-[#d99b43]/12" /><div className="relative flex items-start justify-between"><div><p className="text-[9px] font-bold uppercase tracking-[.2em] text-[#e2b96c]">Aduvia</p><p className="mt-1 text-[8px] uppercase tracking-[.14em] text-white/70">Monthly constellation</p></div><p className="text-[9px] font-semibold uppercase tracking-[.15em] text-white/75">August</p></div><div className="relative mx-auto mt-5 h-[47%] w-[92%]"><span className="absolute left-1/2 top-1/2 h-[36%] w-[48%] -translate-x-1/2 -translate-y-1/2 -rotate-6 rounded-[50%] border border-white/18" /><span className="absolute left-1/2 top-1/2 h-[52%] w-[68%] -translate-x-1/2 -translate-y-1/2 rotate-3 rounded-[50%] border border-white/14" /><span className="absolute left-1/2 top-1/2 h-[70%] w-[88%] -translate-x-1/2 -translate-y-1/2 -rotate-3 rounded-[50%] border border-white/12" /><span className="absolute left-[23%] top-[38%] size-2 rounded-full bg-[#d99b43] shadow-[0_0_12px_#d99b43]" /><span className="absolute right-[18%] top-[55%] size-2 rounded-full bg-[#9bc9c1]" /><span className="absolute bottom-[14%] left-[42%] size-1.5 rounded-full bg-[#d99b43]" /><div className="absolute left-1/2 top-1/2 grid size-24 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border-[7px] border-[#d99b43] bg-[#173f32] text-center"><div><p className="text-3xl font-semibold tracking-[-.06em]">71%</p><p className="text-[6px] uppercase tracking-[.16em] text-white/75">rhythm</p></div></div></div><div className="relative grid grid-cols-3 gap-3 rounded-[20px] bg-[#f3e7ca] p-4 text-[#203029]"><div><p className="text-xl font-semibold">24</p><p className="text-[7px] text-[#594d46]">days in orbit</p></div><div><p className="text-xl font-semibold">4</p><p className="text-[7px] text-[#594d46]">daily rituals</p></div><div><p className="text-xl font-semibold">2</p><p className="text-[7px] text-[#594d46]">quests landed</p></div></div><p className="absolute bottom-3 left-7 rounded-full bg-[#173f32] px-2.5 py-1 text-[8px] font-semibold uppercase tracking-[.14em] text-white">Small steps · visible proof</p></div></div>
        </div>
      </section>
      ...
      <footer className="bg-[#173f32] text-white"><div className="mx-auto flex max-w-[1500px] flex-col gap-5 px-5 py-8 text-xs text-white/70 sm:flex-row sm:items-center sm:justify-between sm:px-9 lg:px-14"><BrandLogo inverse /><p>Build gently. Finish meaningfully.</p><div className="flex gap-5"><Link href="/login">Log in</Link><Link href="/signup">Sign up</Link></div></div></footer>
    </main>
  );
}
