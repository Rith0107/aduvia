...
export function MonthlyReport() {
  ...
  const shareTrim = shareDesign === "passport" || shareDesign === "passport-v2" ? "archive" : shareDesign === "cover" || shareDesign === "cover-v2" ? "aurora" : "orbit";
            ...
            <div className="grid gap-5 xl:grid-cols-[0.78fr_1.22fr]">
              <div className="flex flex-col p-4 sm:p-6">
                ...
                <fieldset className="mt-6">
                  ...
                  <div className="mt-3 grid max-w-md grid-cols-2 gap-2 sm:grid-cols-3">{(["orbit", "passport-v2", "cover-v2", "ticket-v2", "ledger-v2", "bento"] as const).map((design) => {
                    const selected = shareDesign === design;
                    const name = design === "orbit" ? "Orbit Signal" : design === "passport-v2" ? "Rhythm Passport" : design === "cover-v2" ? "Month Cover" : design === "ticket-v2" ? "Afterglow Ticket" : design === "ledger-v2" ? "Return Log" : "Insight Bento";
