...
export function OnboardingScreen() {
  ...
  return <main className="public-canvas min-h-screen px-4 py-5 text-[var(--soft-ink)] sm:px-7 sm:py-7">
    ...
    <div className="public-surface mx-auto flex min-h-[calc(100vh-2.5rem)] max-w-[1280px] flex-col overflow-hidden rounded-[36px]">
      <header className="public-toolbar flex items-center justify-between border-b px-6 py-5 sm:px-10"><BrandLogo /><button className="text-xs font-bold text-[var(--soft-muted)] hover:text-[var(--soft-ink)] disabled:opacity-50" disabled={finishing} onClick={() => void skip()} type="button">Set up later</button></header>
