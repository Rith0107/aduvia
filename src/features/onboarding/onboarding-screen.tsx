...
export function OnboardingScreen() {
  ...
  const canContinue = Boolean(customHabit) && customDays.length > 0;
  ...
  async function finish(includeQuest = true) {
    ...
    if (customHabit) selectedHabits.push({ id: crypto.randomUUID(), isAnchor: customHabit === selectedAnchor, name: customHabit, category: "Personal", frequency: customDays.length === 7 ? "Daily" : "Custom", scheduledDays: customDays, color: "green", consistency: 0, streak: 0, state: "active" });
